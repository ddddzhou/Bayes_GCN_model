...
def main():
    ...
    raw_data = pd.read_csv('./datasets XMR/raw/XMR.csv')['Close']
    ...
    traindata = np.genfromtxt('./datasets XMR/XMR_train.txt', delimiter = ' ') # scaled between 0,1 for sigmoid fuunction in output layer
    testdata = np.genfromtxt('./datasets XMR/XMR_test.txt', delimiter = ' ')
